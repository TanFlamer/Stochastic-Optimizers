...
Genetic Algoritm study & \textbf{1} & \textbf{1.3} & 8.7 & \textit{31e-1}\textit{/300} & . & \textbf{.} & \textbf{.} & \textbf{.} & \textbf{.} & \textbf{.} & Genetic Algoritm study \cite{add_an_entry_for_Genetic Algoritm study_in_bbob.bib}\\
PSO Bounded & \textbf{1} & \textbf{1.6} & \textbf{3} & \textbf{5.2} & \textbf{7.4} & \textbf{\textit{67e-3}\textit{/200}} & \textbf{.} & \textbf{.} & \textbf{.} & \textbf{.} & PSO Bounded \cite{add_an_entry_for_PSO Bounded_in_bbob.bib}
\end{tabular}
