...
\includegraphics[trim=5mm 0mm 0mm 0mm, clip, width=0.22\textwidth]{ppdata_f115}\\\hline
...
\rot{all functions}
\includegraphics[width=0.268\textwidth]{pprldistr_dim05nzall} & 
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 0, clip]{ppfvdistr_dim05nzall} &
\includegraphics[width=0.268\textwidth]{pprldistr_dim20nzall} &
\includegraphics[width=0.2362\textwidth,trim=2.40cm 0 0 0, clip]{ppfvdistr_dim20nzall} \\
\rot{moderate noise}
...
\rot{all functions}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth, trim=0 0 16mm 12mm, clip]{pplogloss_dim05nzall} &
\includegraphics[width=0.24\textwidth, trim=7mm 0 9mm 12mm, clip]{pplogloss_dim20nzall} \\[-2ex]
\rot{moderate noise}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth, trim=0 0 16mm 12mm, clip]{pplogloss_dim05nzmod} &
\includegraphics[width=0.24\textwidth, trim=7mm 0 9mm 12mm, clip]{pplogloss_dim20nzmod} \\[-2ex]
\rot{severe noise}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth, trim=0 0 16mm 12mm, clip]{pplogloss_dim05nzsev} &
\includegraphics[width=0.24\textwidth, trim=7mm 0 9mm 12mm, clip]{pplogloss_dim20nzsev} \\[-2ex]
\rot[0.5]{severe noise multimod.}
\hspace*{-2mm}
\includegraphics[width=0.24\textwidth, trim=0 0 16mm 12mm, clip]{pplogloss_dim05nzsmm} &
\includegraphics[width=0.24\textwidth, trim=7mm 0 9mm 12mm, clip]{pplogloss_dim20nzsmm}
\end{tabular}
...
\centering
\input{\bbobdatapath pploglosstable_dim05nzall}
\input{\bbobdatapath pploglosstable_dim20nzall}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
